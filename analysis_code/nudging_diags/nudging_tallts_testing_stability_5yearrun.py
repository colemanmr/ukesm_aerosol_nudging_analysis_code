...
filename = 'by965_nudge_diags_copygrid_fiveyearrun_apm.pp'
...
#iplt.plot(processed_input[0,:50,72,96], color = 'c', marker = 'x', linewidth = 0.5, label = 'processed_input')
...
plt.savefig(plot_directory + '/fixed_by965_time_step_yearrun_2014-12_nudging_diag_profile_analysis_copygrid_yearrun_trop',\
            dpi = 300)
plt.show()
...
#plt.legend()
#plt.tight_layout()
#plt.savefig(plot_directory + '/fixed_by937_time_step_yearrun_2014-'+ str(month) + '-01_0600Z_nudging_diag_profile_differences_copygrid_yearrun',\
#            dpi = 300)
#plt.show()
