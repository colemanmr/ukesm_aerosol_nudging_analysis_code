...
plt.savefig(plot_directory + '/fixed_bw842_time_step_54_nudging_diag_profile_analysis',\
            dpi = 300)
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig(plot_directory + '/fixed_bw842_time_step_54_nudging_diag_profile_differences',\
            dpi = 300)
plt.show()
