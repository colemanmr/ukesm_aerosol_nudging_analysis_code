...
plt.savefig(plot_directory + 'level_mean_theta_su_adjustments_profile_best_case_su_nudge_lev1', dpi=300)
plt.show()
...
plt.savefig(plot_directory + 'level_mean_theta_cont_errors_profile_best_case_su_nudge_lev1', dpi=300)
plt.show()
...
# plt.savefig(plot_directory + 'level_mean_theta_su_adjustments_rms_profile_best_case_su_nudge_lev1', dpi=300)
plt.show()
...
# plt.savefig(plot_directory + 'level_mean_theta_cont_errors_rms_profile_best_case_su_nudge_lev1', dpi=300)
plt.show()
