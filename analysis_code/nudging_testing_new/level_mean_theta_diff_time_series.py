...
nudged_pert_file_monthly = diag_dir + 'theta_month_mean_ch278_2014.pp'
nudged_pert_monthly = iris.load_cube(nudged_pert_file_monthly)
...
# ## # nudged_pert_file_monthly = diag_dir + 'theta_month_mean_ch278_2014_jan-jun.pp'
# nudged_pert_file_monthly = diag_dir + 'theta_month_mean_ci000_2014.pp'
# nudged_pert_monthly = iris.load_cube(nudged_pert_file_monthly)
...
# ## # nudged_pert_file_monthly = diag_dir + 'theta_month_mean_ch278_2014_jan-jun.pp'
# nudged_pert_file_monthly = diag_dir + 'theta_month_mean_ch424_2014.pp'
# nudged_pert_monthly = iris.load_cube(nudged_pert_file_monthly)
...
# # G=1/6 uvt BL level 1 nudged input
# nudged_cont_file_monthly = diag_dir + 'theta_month_mean_cj765.pp'
# nudged_cont_monthly = iris.load_cube(nudged_cont_file_monthly)

# nudged_pert_file_monthly = diag_dir + 'theta_month_mean_cj766.pp'
# nudged_pert_monthly = iris.load_cube(nudged_pert_file_monthly)
...
save_target = new_plot_dir + 'monthly_level_mean_theta_adjustment_time_series_ch277-ch278_2014'
...
for i in range(len(index_levels)):
    ...
    time_series = np.linspace(1, 12, num=12)
    plt.plot(time_series[0:12], level_mean_nudged_adjustment_monthly_array, label = level_labels[i])
# plt.plot(time_series[0:60], area_mean_nudged_adjustment_monthly_surf_t_array, color = 'magenta', label = 'surf_t')
plt.legend(loc = 'upper right', ncol = 3)
plt.xlabel('Months')
plt.ylabel('Theta adjustment / K ')
plt.xlim(-5,125)
plt.ylim(-0.21, 0.14)
# plt.ylim(-4.5,3.5)
