...
# # plt.legend()
# # plt.savefig(plot_directory + 'level_mean_u_wind_su_adjustments_profile_', dpi=300)
# plt.show()
...
# # plt.legend()
# # plt.savefig(plot_directory + 'level_mean_v_wind_su_adjustments_profile', dpi=300)
# plt.show()
...
plt.savefig(plot_directory + 'level_mean_u_wind_su_adjustments_rms_profile_nudge_lev1',
...
# plt.legend()
plt.savefig(plot_directory + 'level_mean_u_wind_cont_errors_rms_profile_nudge_lev1',
             dpi = 300, bbox_inches='tight')
plt.show()
...
plt.legend(loc = 'center right', ncol = 1, fontsize = 'small', \
            labelspacing = 0.2, columnspacing = 0.5, borderaxespad = 0.2,\
                handleheight = 0.3\
                   )
plt.savefig(plot_directory + 'level_mean_v_wind_su_adjustments_rms_profile_nudge_lev1',
             dpi = 300, bbox_inches='tight')
plt.show()
...
plt.legend(loc = 'upper right', ncol = 2, fontsize = 'small', \
            labelspacing = 0.2, columnspacing = 0.2, borderaxespad = 0.1,\
                handleheight = 1.8\
                   )
plt.savefig(plot_directory + 'level_mean_v_wind_cont_errors_rms_profile_nudge_lev1',
             dpi = 300, bbox_inches='tight')
plt.show()
