...
cont_file_1 = iris.load(diag_dir + 'aer_burden_mode_nmbr_ratios_sol_br793_2015-2028')
cont_file_2 = iris.load(diag_dir + 'aer_burden_mode_nmbr_ratios_sol_br793_2029-2048')

# check cubes loaded in correct order
print(cont_file_1)
print(cont_file_2)
...
iris.save(cont_cubelist, diag_dir + 'aer_burden_mode_nmbr_ratios_sol_br793_time_mean.pp')
