...
### Note: have assumed sims have 0 year spinup ### 

# Pass all, cleanr clearclean sky forcings for a pair of suites
parser = argparse.ArgumentParser()
parser.add_argument('all_sky_forcing',\
                    type = str,\
                    help = '.nc file of all sky forcing')
parser.add_argument('clear_sky_forcing',\
                    type = str,\
                    help = '.nc file of clear sky forcing')
...
# Load clear sky forcing cubes
clear_sky_area_sw, clear_sky_area_lw, clear_sky_area_net, \
clear_sky_time_sw, clear_sky_time_lw, clear_sky_time_net = \
iris.load(args.clear_sky_forcing, names)
...
dre_area_mean_net_forcing = flux_mod.cube_diff(clear_sky_area_net,\
                                           clearclean_sky_area_net)
dre_area_mean_sw_forcing = flux_mod.cube_diff(clear_sky_area_sw,\
                                           clearclean_sky_area_sw)
dre_area_mean_lw_forcing = flux_mod.cube_diff(clear_sky_area_lw,\
                                           clearclean_sky_area_lw)

#print(dre_area_mean_sw_forcing)

# Calculate time meaned forcing for forcing maps
dre_time_mean_net_forcing = flux_mod.cube_diff(clear_sky_time_net,\
                                           clearclean_sky_time_net)
dre_time_mean_sw_forcing = flux_mod.cube_diff(clear_sky_time_sw,\
                                           clearclean_sky_time_sw)
dre_time_mean_lw_forcing = flux_mod.cube_diff(clear_sky_time_lw,\
...
# Calculate annual area meaned forcings for forcing time series plots
cre_area_mean_net_forcing = flux_mod.cube_diff(all_sky_area_net,\
                                           clear_sky_area_net)
cre_area_mean_sw_forcing = flux_mod.cube_diff(all_sky_area_sw,\
                                           clear_sky_area_sw)
cre_area_mean_lw_forcing = flux_mod.cube_diff(all_sky_area_lw,\
                                           clear_sky_area_lw)

# Calculate time meaned forcing for forcing maps
cre_time_mean_net_forcing = flux_mod.cube_diff(all_sky_time_net,\
                                           clear_sky_time_net)
cre_time_mean_sw_forcing = flux_mod.cube_diff(all_sky_time_sw,\
                                           clear_sky_time_sw)
cre_time_mean_lw_forcing = flux_mod.cube_diff(all_sky_time_lw,\
                                           clear_sky_time_lw)
...
dre_target = diag_dir + args.all_sky_forcing.replace('all', 'dre_alternative_order')
cre_target = diag_dir + args.all_sky_forcing.replace('all', 'cre_alternative_order')
