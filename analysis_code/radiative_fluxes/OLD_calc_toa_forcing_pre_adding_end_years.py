...
area_time_net_forcing = flux_mod.time_mean_cube(area_mean_net_forcing[spinup:])
area_time_sw_forcing = flux_mod.time_mean_cube(area_mean_sw_forcing[spinup:])
area_time_lw_forcing = flux_mod.time_mean_cube(area_mean_lw_forcing[spinup:])
